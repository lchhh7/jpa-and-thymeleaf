...
public class HolidayUtils {
    ...
    public static Map<String, Object> holidayInfoAPI(String year) throws IOException {
        ...
        urlBuilder.append("?" + URLEncoder.encode("serviceKey", "UTF-8") + "=" + "0fAx%2FuNmJVt33aosHxYitGhATFHxechg1AaVHqevMXFWi3F6zn6VDLWR5TlY%2FljIQMDGg1DfL7uWB3NUgMypTA%3D%3D"); /*Service Key*/
